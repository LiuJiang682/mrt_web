...
//	private static final String CLASS_FIELD_JSON = "{\"SL4\":[{\"LOC_SITE\":\"SITE_ID,EASTING,NORTHING,LATITUDE,LONGITUDE\"},{\"DH_BOREHOLE\":\"DILLING_DETAILS_ID,DEPTH,ELEVATION_KB,AZIMUTH_MAG\"}],\"DS4\":[{\"DH_DOWNHOLE\":\"SURVEYED_DEPTH,AZIMUTH_MAG,DIP\"}]}";
	private static final String HEADERS_JSON = "{\"SL4\":\"H1000-false,H1001-true,H1004-true\",\"DS4\":\"H1000-false,H1001-true,H1004-true\"}";
...
//	@Ignore
	...
	@SuppressWarnings("unchecked")
	private Map<String, Object> getHeaderMap() throws JsonParseException, JsonMappingException, IOException {
		return new ObjectMapper().readValue(HEADERS_JSON, HashMap.class);
	}
