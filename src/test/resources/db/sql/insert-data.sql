...
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS) 
    values (1, 'KPDD001', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1);
    
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS) 
    values (12, 'KPDD001', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1);    
    
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS) 
    values (12, 'KPDD002', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1);        
    
INSERT INTO DH_BOREHOLE(LOADER_ID, HOLE_ID, BH_AUTHORITY_CD, BH_REGULATION_CD, DILLING_DETAILS_ID, DRILLING_START_DT, DRILLING_COMPLETION_DT, DEPTH, ELEVATION_KB, AZIMUTH_MAG, BH_CONFIDENTIAL_FLG, DEPTH_UOM) 
    values (1, 'KPDD001', 'U', 'N/A', 1, sysdate, sysdate, 210, 320, null, 'Y', 'MTR');    
    
INSERT INTO DH_BOREHOLE(LOADER_ID, HOLE_ID, BH_AUTHORITY_CD, BH_REGULATION_CD, DILLING_DETAILS_ID, DRILLING_START_DT, DRILLING_COMPLETION_DT, DEPTH, ELEVATION_KB, AZIMUTH_MAG, BH_CONFIDENTIAL_FLG, DEPTH_UOM) 
    values (12, 'KPDD001', 'U', 'N/A', 1, sysdate, sysdate, 210, 320, null, 'Y', 'MTR'); 

INSERT INTO DH_BOREHOLE(LOADER_ID, HOLE_ID, BH_AUTHORITY_CD, BH_REGULATION_CD, DILLING_DETAILS_ID, DRILLING_START_DT, DRILLING_COMPLETION_DT, DEPTH, ELEVATION_KB, AZIMUTH_MAG, BH_CONFIDENTIAL_FLG, DEPTH_UOM) 
    values (12, 'KPDD002', 'U', 'N/A', 1, sysdate, sysdate, 210, 320, null, 'Y', 'MTR'); 
...
INSERT INTO DH_DOWNHOLE(ID, LOADER_ID, HOLE_ID, SURVEYED_DEPTH, AZIMUTH_MAG, DIP, AZIMUTH_TRUE)
    VALUES (1, 1, 'KPDD001', 30, 180, 60, NULL);
    
INSERT INTO DH_LITHOLOGY(ID, LOADER_ID, HOLE_ID, DEPTH_FROM)
    VALUES (1, 1, 'KPDD001', 3);    
    
INSERT INTO DH_GEOCHEMISTRY(ID, LOADER_ID, HOLE_ID, SAMPLE_ID, SAMPLE_FROM, SAMPLE_TO, DRILL_CODE)
    VALUES (1, 1, 'KPDD001', 'ABC123', 0, 1, 'DD');
    
INSERT INTO DH_SURFACE_GEOCHEMISTRY(ID, LOADER_ID, SAMPLE_ID, EASTING, NORTHING, SAMPLE_TYPE, AMG_ZONE)
    VALUES (1, 1, 'KPDD001', 0, 1, 'DD', 54);    
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (1, 1, 'SL4', 'Au', '1', '0.01');    
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (2, 1, 'SL4', 'H1000', 'H1000', 'Hole_id,NAT_Grid_ID,Easting_MGA,Northing_MGA,Elevation,Total Hole Depth,Drill Code,Nat_Survey_Method,Precollar_Depth,Dip,Azimuth_MAG,Lease_ID,Prospect,Date_Started,Date_Completed,Company,Comments');   

INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (3, 12, 'SL4', 'H1000', 'H1000', 'Hole_id,NAT_Grid_ID,Easting_MGA,Northing_MGA,Elevation,Total Hole Depth,Drill Code,Nat_Survey_Method,Precollar_Depth,Dip,Azimuth_MAG,Lease_ID,Prospect,Date_Started,Date_Completed,Company,Comments');  

INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (4, 100, 'SL4', 'H1000', 'H1000', 'Hole_id,NAT_Grid_ID,Easting_MGA,Northing_MGA,Elevation,Total Hole Depth,Drill Code,Nat_Survey_Method,Precollar_Depth,Dip,Azimuth_MAG,Lease_ID,Prospect,Date_Started,Date_Completed,Company,Comments');  
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (5, 1, 'DS4', 'H1000', 'H1000', 'Hole_id');  
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (6, 12, 'SL4', 'Au', '1', '0.01');    
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (7, 12, 'SL4', 'Au', '2', '0.01');     
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (8, 100, 'DS4', 'H1000', 'H1000', 'Hole_id,Sureryed_Depth,Azimuth_Mag,Dip,Azimuth_True');  
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (9, 100, 'DL4', 'H1000', 'H1000', 'Hole_id,Depth_from'); 
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (10, 100, 'DG4', 'H1000', 'H1000', 'Hole_id,Sample_id,Sample_from,Sample_to,Drill_code');  
    
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (11, 100, 'SG4', 'H1000', 'H1000', 'Sample_id,Easting,Northing,Sample_type');    
...
INSERT INTO TEMPLATE_DISPLAY_PROPERTIES(ID, TEMPLATE, DISPLAY_PROPERTIES) 
    values (100, 'MRT', '{"SL4":[{"LOC_SITE":"SITE_ID,EASTING,NORTHING,LATITUDE,LONGITUDE"},{"DH_BOREHOLE":"DRILL_TYPE,DEPTH,ELEVATION_KB,AZIMUTH_MAG-SQL:SELECT b.DRILL_TYPE, a.DEPTH, a.ELEVATION_KB, a.AZIMUTH_MAG FROM DH_BOREHOLE a, DH_DRILLING_DETAILS b where a.DILLING_DETAILS_ID = b.ID AND a.LOADER_ID = ?"}],"DS4":[{"DH_DOWNHOLE":"SURVEYED_DEPTH,AZIMUTH_MAG,DIP"}],"DL4":[{"DH_LITHOLOGY":"HOLE_ID,DEPTH_FROM"}],"DG4":[{"DH_GEOCHEMISTRY":"HOLE_ID,SAMPLE_ID,SAMPLE_FROM,SAMPLE_TO,DRILL_CODE"}],"SG4":[{"DH_SURFACE_GEOCHEMISTRY":"SAMPLE_ID,EASTING,NORTHING,SAMPLE_TYPE"}]}')    