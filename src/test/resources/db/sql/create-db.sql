...
DROP TABLE if exists template_updater_config;
...
DROP TABLE if exists DH_DRILLING_DETAILS ;
...
DROP TABLE if exists lOC_SITE;
CREATE OR REPLACE TABLE lOC_SITE (
...
DROP TABLE if exists DH_BOREHOLE;
CREATE OR REPLACE TABLE DH_BOREHOLE (    
    LOADER_ID BIGINT NOT NULL, 
...
DROP TABLE if exists TEMPLATE_CONTEXT_PROPERTIES;
CREATE OR REPLACE TABLE TEMPLATE_CONTEXT_PROPERTIES (    
    ID BIGINT NOT NULL, 
...
DROP TABLE if exists DH_DOWNHOLE;
CREATE OR REPLACE TABLE DH_DOWNHOLE (    
    ID BIGINT NOT NULL, 
...
DROP TABLE if exists DH_LITHOLOGY;
CREATE OR REPLACE TABLE DH_LITHOLOGY (    
    ID BIGINT NOT NULL, 
    LOADER_ID BIGINT DEFAULT NULL NOT NULL,
    HOLE_ID VARCHAR2(250) DEFAULT NULL NOT NULL,
    FILE_NAME VARCHAR(50) NOT NULL,
...
DROP TABLE if exists DH_GEOCHEMISTRY;
CREATE OR REPLACE TABLE DH_GEOCHEMISTRY (    
    ID BIGINT NOT NULL, 
    LOADER_ID BIGINT DEFAULT NULL NOT NULL,
    HOLE_ID VARCHAR2(250) DEFAULT NULL NOT NULL,
...
DROP TABLE if exists DH_SURFACE_GEOCHEMISTRY;
CREATE OR REPLACE TABLE DH_SURFACE_GEOCHEMISTRY (    
    ID BIGINT NOT NULL, 
    LOADER_ID BIGINT DEFAULT NULL NOT NULL,
    SAMPLE_ID VARCHAR2(250) DEFAULT NULL NOT NULL,
    FILE_NAME VARCHAR(50) NOT NULL,
...
DROP TABLE if exists DH_OPTIONAL_FIELDS;
CREATE OR REPLACE TABLE DH_OPTIONAL_FIELDS (    
    ID BIGINT NOT NULL, 
    LOADER_ID BIGINT DEFAULT NULL NOT NULL,
    FILE_NAME VARCHAR(50) NOT NULL,
    TEMPLATE_NAME VARCHAR(100) DEFAULT NULL NOT NULL, 
    TEMPLATE_HEADER VARCHAR(100) DEFAULT NULL NOT NULL, 
    ROW_NUMBER DECIMAL DEFAULT 0 NOT NULL, 
    COLUMN_NUMBER DECIMAL DEFAULT 0 NOT NULL,
    FIELD_VALUE VARCHAR2(4000) DEFAULT NULL
);

DROP TABLE if exists TEMPLATE_DISPLAY_PROPERTIES;
CREATE OR REPLACE TABLE TEMPLATE_DISPLAY_PROPERTIES (    
    ID BIGINT NOT NULL, 
    TEMPLATE VARCHAR2(30) NOT NULL, 
    DISPLAY_PROPERTIES  VARCHAR(4000),
    HEADER_FIELDS  VARCHAR(4000),
    TEMPLATE_RETRIEVER  VARCHAR(4000)
);

DROP TABLE if exists DH_MANDATORY_HEADERS;
CREATE OR REPLACE TABLE DH_MANDATORY_HEADERS (
    ID BIGINT NOT NULL, 
    LOADER_ID BIGINT DEFAULT NULL NOT NULL,
    TEMPLATE_NAME VARCHAR(250) DEFAULT NULL NOT NULL, 
    FILE_NAME VARCHAR(50) DEFAULT NULL NOT NULL,
    ROW_NUMBER  VARCHAR(10) DEFAULT 0 NOT NULL, 
    COLUMN_HEADER VARCHAR(100) DEFAULT NULL NOT NULL,
